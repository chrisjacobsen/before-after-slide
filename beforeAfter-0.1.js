/*!
 * jQuery Before After Slide Plugin 0.1
 * 
 * Copyright 2012, Christopher Jacobsen
 * chrisjaotearoa@gmail.com
 * 
...
;(function ($) {
    ...
    Plugin.prototype.init = function () {
		...
		function move_after(x) {
			...
			$(eId +" ."+wrapClass).width(x+"px");
			$(eId +" ."+lineClass).css({"left":x});
		}
		// set up mouse move binding
		// $(window).on("mousemove", moveSelector, function (e) {
		...
		$(eId+" img").css({"margin": "0", "padding": "0", "border": "0"});
		// add the extra wrap and line elements
		$(eId+" img:last").wrap('<div class="'+wrapClass+'" style="position:relative; top: -'+imgHeight+'; overflow:hidden; width:0;" />');
